...
public class RPG_Game {
    public class RPG_Game {
        ...
        public static void startGame() {
            ...
            Warrior warrior = new Warrior(270, 10, "Baki");
            Medic doc = new Medic(250, 0, "Strange", 15);
            Magic magic = new Magic(260, 15, "Potter");
            Berserk berserk = new Berserk(280, 20, "Viking");
            Medic assistant = new Medic(290, 5, "Stone", 5);
            Thor thor=new Thor(270,22,"Thor");
            Golem golem=new Golem(400,3,"Golem");
            Hacker hacker=new Hacker(270,14,"Hacker");
